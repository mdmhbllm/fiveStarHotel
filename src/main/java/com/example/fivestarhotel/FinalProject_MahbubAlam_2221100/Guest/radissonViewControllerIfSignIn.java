...
public class radissonViewControllerIfSignIn {
    @FXML
    ...
    public void initialize() throws IOException, ClassNotFoundException {
        ...
        Room room5 = new Room("201", "Single", 130.0, "Available", "Cozy single room with city view");
        Room room6 = new Room("202", "Double", 150.0, "Available", "Spacious double room with balcony");
        Room room7 = new Room("203", "Single", 140.0, "Sold Out", "Single room with garden view");
        Room room8 = new Room("301", "Suite", 250.0, "Sold Out", "Luxury suite with sea view");
    ...
    public void userProfileOnAction(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader =  new FXMLLoader(radissonViewControllerIfSignIn.class.getResource("profileView.fxml"));;
