...
public class ListOfHotelIfSignInController {
    ...
    @Deprecated
    public void recieveInfoFromGuestControllerIfSignIn(String destination, LocalDate checkInDate, String roomCount, String guestCount) throws IOException {
    ...
    public void editSearchLabel(ActionEvent actionEvent) throws IOException {
        FXMLLoader loader = new FXMLLoader(GuestControllerIfNotSignIn.class.getResource("guestViewIfSignIn.fxml"));
    ...
    public void userProfileOnAction(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader =  new FXMLLoader(ListOfHotelIfSignInController.class.getResource("profileView.fxml"));;
